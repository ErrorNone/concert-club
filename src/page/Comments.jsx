  ...
  return (
    <div className="mt-5">
      ...
      // strong version
        ...
        <Row className="mb-2">
          <Col className="justify-content-center">
            <Button variant="dark" className="rounded-0 fw-bold" onClick={handleShow}>
              Добавить комментарий
            </Button>
          </Col>
        </Row>
        <Modal show={show} onHide={handleClose} centered>
          ...
          <Modal.Footer>
            <Button variant="dark" className="rounded-0 fw-bold" onClick={handleClose}>
              Закрыть
            </Button>
            <Button variant="dark" className="rounded-0 fw-bold" onClick={sendComment}>
              Отправить
            </Button>
          </Modal.Footer>
        </Modal>
