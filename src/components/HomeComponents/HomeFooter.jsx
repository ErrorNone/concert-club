        ...
        <Col md={6} className="mb-4">
          <Form className="border border-gray-500  p-3">
            <FormGroup>
              ...
              />
              <Button variant="dark" className="rounded-0" onClick={sendOffer}>
                отправить
              </Button>
            </FormGroup>
          </Form>
      ...
      <Row>
        ...
        <Col md={6} className="mb-4">
          <Form className="border border-gray-500  p-3">
            <FormGroup>
              <FormLabel>
                <h5 className="fw-bold">Оставить заявку на проведение концерта</h5>
              </FormLabel>
              <FormControl
                as="textarea"
                placeholder="Расскажите о вашем предложении "
                ...
                onChange={(e) => setOffer(e.target.value)}
              />
              <Button variant="dark" className="rounded-0 fw-bold" onClick={sendOffer}>
                отправить
              </Button>
            </FormGroup>
          </Form>
